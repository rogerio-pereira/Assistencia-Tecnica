...
@NamedQueries
({
	//@NamedQuery(name = "EmailsFornecedores.findAll", query = "SELECT DISTINCT e.email FROM EmailsFornecedores e"),
})
public class EmailsFornecedores
{
    @Id
    @GeneratedValue
    private Long codigo;
