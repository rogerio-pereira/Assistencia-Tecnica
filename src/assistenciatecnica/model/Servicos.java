...
@NamedQueries
({
	@NamedQuery(name = "Servicos.findAll",	query = "SELECT servico FROM Servicos s ORDER BY s.codigo ASC"),
	@NamedQuery(name = "Servicos.findOne",	query = "SELECT s.codigo FROM Servicos s WHERE s.servico = ?0")
})
