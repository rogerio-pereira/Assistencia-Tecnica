...
import assistenciatecnica.model.EmailsFornecedores;
import assistenciatecnica.model.Fornecedores;
import assistenciatecnica.model.TelefonesFornecedores;
 ...
 * @author farofa
 */
public class CadastroFornecedores extends javax.swing.JFrame implements KeyListener, ContainerListener{
	...
	/*
	 * M̩todo Valida Campos
	 * Verifica se todos os campos obrigatorios esṭo marcados
	 */
	...
	/*
	 * M̩todo getFornecedorByCodigo
	 * Obtem o cliente pelo Codigo
	 */
	public void getFornecedorByCodigo()
	{
		this.control		= new ControladorFornecedores();
		this.fornecedor	= control.getFornecedorByCodigo(this.codigo, this);
        
		//Insere os dados na janela
		this.textoCodigo.setText(this.codigo.toString());
		this.textoNome.setText(this.fornecedor.getNome());
		if(this.fornecedor.getPessoa() == true)
		{
		...
		else if(this.fornecedor.getPessoa() == false)
		{
			...
			this.textoCNPJ.setText(this.fornecedor.getCnpj());
			this.textoCPFResponsavel.setText(this.fornecedor.getCpfResponsavel());
			this.textoRGResponsavel.setText(this.fornecedor.getRgResponsavel());
			this.textoResponsavel.setText(this.fornecedor.getResponsavel());
		}
		this.textoEndereco.setText(this.fornecedor.getEndereco());
		this.textoNumero.setText(String.valueOf(this.fornecedor.getNumero()));
		this.textoBairro.setText(this.fornecedor.getBairro());
		this.textoComplemento.setText(this.fornecedor.getComplemento());
		this.textoCidade.setText(this.fornecedor.getCidade());
		this.comboEstado.setSelectedIndex(this.fornecedor.getEstado());
		this.textoCEP.setText(this.fornecedor.getCep());
		this.textoObs.setText(this.fornecedor.getObservacao());
		
		//Telefones
		this.telefones = this.fornecedor.getTelefones();
		for(TelefonesFornecedores telefone : telefones)
		{
		...
		//E-mails
		this.emails = this.fornecedor.getEmails();
		for(EmailsFornecedores email : emails)
		{
    ...
    private void initComponents()
    {
        ...
        botaoLocalizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assistenciatecnica/view/img/magnifier.png"))); // NOI18N
        ...
        botaoAdicionarTelefone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assistenciatecnica/view/img/telephone_add.png"))); // NOI18N
        ...
        botaoRemoverTelefone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assistenciatecnica/view/img/telephone_delete.png"))); // NOI18N
        ...
        painelTelefonesLayout.setVerticalGroup(
            ...
            .addGroup(painelTelefonesLayout.createSequentialGroup()
                .addGroup(painelTelefonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelTelefone)
                    .addComponent(botaoAdicionarTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(botaoRemoverTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ScrollTelefone, javax.swing.GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        botaoAdicionarEmail.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assistenciatecnica/view/img/email-add.png"))); // NOI18N
        ...
        botaoRemoverEmail.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assistenciatecnica/view/img/email-delete.png"))); // NOI18N
        ...
        PainelEmailLayout.setVerticalGroup(
            ...
            .addGroup(PainelEmailLayout.createSequentialGroup()
                .addGroup(PainelEmailLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelEmail)
                    .addComponent(botaoAdicionarEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(botaoRemoverEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ScrollEmail, javax.swing.GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        PainelObsLayout.setVerticalGroup(
            ...
            .addGroup(PainelObsLayout.createSequentialGroup()
                ...
                .addComponent(labelObs)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(painelObs, javax.swing.GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(botaoLocalizar, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private void textoObsKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoObsKeyTyped
    ...
    {//GEN-HEADEREND:event_botaoSalvarActionPerformed
		...
		if(this.validaCampos())
		{
			...
			if(this.textoCodigo.getText().equals("** NOVO **"))
				...
				this.fornecedor = control.getFornecedorByCodigo(Long.parseLong(this.textoCodigo.getText()), this);

			//Definindo os dados
			this.fornecedor.setNome(this.textoNome.getText());
			if(this.radioPessoaFisica.isSelected())
				this.fornecedor.setPessoa(true);
			else if(this.radioPessoaJuridica.isSelected())
				this.fornecedor.setPessoa(false);
			this.fornecedor.setRg(this.textoRG.getText());
			this.fornecedor.setCpf(this.textoCPF.getText());
			this.fornecedor.setNascimento(this.textoNascimento.getCalendar());
			if(this.radioMasculino.isSelected())
				this.fornecedor.setSexo(true);
			if(this.radioFeminino.isSelected())
				this.fornecedor.setSexo(false);
			this.fornecedor.setCnpj(this.textoCNPJ.getText());
			this.fornecedor.setCpfResponsavel(this.textoCPFResponsavel.getText());
			this.fornecedor.setRgResponsavel(this.textoRGResponsavel.getText());
			this.fornecedor.setResponsavel(this.textoResponsavel.getText());
			this.fornecedor.setEndereco(this.textoEndereco.getText());
			this.fornecedor.setNumero(Integer.parseInt(this.textoNumero.getText()));
			this.fornecedor.setBairro(this.textoBairro.getText());
			this.fornecedor.setComplemento(this.textoComplemento.getText());
			this.fornecedor.setCidade(this.textoCidade.getText());
			this.fornecedor.setEstado(this.comboEstado.getSelectedIndex());
			this.fornecedor.setCep(this.textoCEP.getText());
			this.fornecedor.setObservacao(this.textoObs.getText());

			//Definindo os telefones
			if(tabelaTelefone.isEditing())
				tabelaTelefone.getCellEditor().stopCellEditing();
			List<TelefonesFornecedores> telefones = new ArrayList<TelefonesFornecedores>();
			for(int i=0; i<tabelaTelefone.getRowCount(); i++)
			{
				TelefonesFornecedores telefone	= new TelefonesFornecedores();
				String				   ramal	= new String("");
			...
			if(tabelaEmail.isEditing())
				tabelaEmail.getCellEditor().stopCellEditing();
			List<EmailsFornecedores> emails = new ArrayList<EmailsFornecedores>();
			for(int i=0; i<tabelaEmail.getRowCount(); i++)
			{
				EmailsFornecedores email = new EmailsFornecedores();
				email.setEmail(tabelaEmail.getValueAt(i, 0).toString());

				emails.add(email);
			}
			this.fornecedor.setEmails(emails);
			
			//Atualizando banco
			if(this.textoCodigo.getText().equals("** NOVO **"))
				controlBD.cadastrar(this.fornecedor, (JFrame)this);
			else
				controlBD.atualizar(this.fornecedor, (JFrame)this);
    ...
    {//GEN-HEADEREND:event_botaoLocalizarActionPerformed
		this.janelaProcuraFornecedores = new ProcuraFornecedores(this, true);
		this.janelaProcuraFornecedores.setVisible(true);
    ...
    {//GEN-HEADEREND:event_botaoExcluirActionPerformed
		...
		controlBD.apagar(codigo, this.fornecedor, (JFrame)this);
	...
	private	ProcuraFornecedores					janelaProcuraFornecedores;
}
