...
public class DadosEmpresa extends javax.swing.JFrame implements KeyListener, ContainerListener{
	...
	private void salvar(int opcao)
	{
		if(this.validaCampos())
		{
			...
			//Definindo os dados
			this.empresa.setNome(this.textoNome.getText());
			this.empresa.setCnpj(this.textoCNPJ.getText());
			this.empresa.setTelefone(this.textoTelefone.getText());
			this.empresa.setFax(this.textoFax.getText());
			this.empresa.setEmail(this.textoEmail.getText());
			this.empresa.setSite(this.textoSite.getText());
			this.empresa.setEndereco(this.textoEndereco.getText());
			this.empresa.setNumero(Integer.parseInt(this.textoNumero.getText()));
			this.empresa.setBairro(this.textoBairro.getText());
			this.empresa.setComplemento(this.textoComplemento.getText());
			this.empresa.setCidade(this.textoCidade.getText());
			this.empresa.setEstado(this.comboEstado.getSelectedIndex());
			this.empresa.setCep(this.textoCEP.getText());
			
			//Atualizando banco
			if(opcao == 1)
				controlBD.cadastrar(this.empresa, (JFrame)this);
			else
				controlBD.atualizar(this.empresa, (JFrame)this);
