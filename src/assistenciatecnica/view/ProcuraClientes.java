 ...
 * Data Cria√ß√£o: 24/02/2014
 */
public class ProcuraClientes extends javax.swing.JDialog implements KeyListener, ContainerListener{

    /** Creates new form ProcuraEquipamento */
    public ProcuraClientes(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
    ...
    {//GEN-HEADEREND:event_botaoPesquisarActionPerformed
		...
		List<Clientes> lista = control.getClientes	(
											this.getCodigo(),
											this.getNome(),
											this.getCpf(),
											this.getCnpj()
    ...
    {//GEN-HEADEREND:event_botaoSelecionarActionPerformed
		if(tabelaClientes.getSelectedRow() != -1)
		{
			...
			if(janela.getTitle() == "Cadastro Clientes")
			{
				janelaCadastroClientes = (CadastroClientes) this.getParent();
				janelaCadastroClientes.codigo = Long.parseLong(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(), 0).toString());
				janelaCadastroClientes.limpaTela();
				janelaCadastroClientes.getClienteByCodigo();
			}
			
			else if(janela.getTitle() == "Ordem de ServiÁo")
			{
				janelaOrdemDeServico = (OrdemDeServico) this.getParent();
				janelaOrdemDeServico.getClienteByCodigo(Long.parseLong(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(), 0).toString()));
			}
	 ...
	 */
	public void insereDados(List<Clientes> lista)
	{
		for(Clientes clientes: lista)
		{
			DefaultTableModel modelo = (DefaultTableModel) tabelaClientes.getModel();
			modelo.addRow(new String[]	{
										clientes.getCodigo().toString(),
										clientes.getNome(),
										clientes.getCpf(),
										clientes.getCnpj(),
									});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcuraClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProcuraClientes dialog = new ProcuraClientes(new javax.swing.JFrame(), true);
