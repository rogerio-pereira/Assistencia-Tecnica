...
public class RestaurarBackup extends javax.swing.JFrame implements KeyListener, ContainerListener
{
    ...
    {//GEN-HEADEREND:event_botaoBackupActionPerformed
		...
		//Backup Restaurado
		if (backup)
			JOptionPane.showMessageDialog(this, "Sucesso ao restaurar o backup!", "Sucesso", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("img/accept-grande.png"));
		//Erro ao restaurar
		else
			JOptionPane.showMessageDialog(this, "Erro ao restarar o backup!", "Erro", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("img/error-circle.png"));
