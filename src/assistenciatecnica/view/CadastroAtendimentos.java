 ...
 */
public class CadastroAtendimentos extends javax.swing.JFrame implements KeyListener, ContainerListener
{

    /** Creates new form CadastroAtendimentos */
    public CadastroAtendimentos() {
        initComponents();
    ...
    {//GEN-HEADEREND:event_botaoCadastrarActionPerformed
		...
		this.atendimento = new Atendimentos();
		this.atendimento.setAtendimento(this.textoNome.getText().toUpperCase());
		controladorBD.cadastrar(this.atendimento, (JFrame)this);
		controlador = null;
    ...
    {//GEN-HEADEREND:event_botaoExcluirActionPerformed
		controlador		= new ControladorAtendimentos();
		controladorBD		= new ControladorBancodeDados();
		
		String categoria	= tabelaAtendimentos.getValueAt(tabelaAtendimentos.getSelectedRow(), 0).toString();
		Long   codigo		= controlador.getCodigoByAtendimento(categoria);
		
		this.atendimento	= new Atendimentos();
		controladorBD.apagar(codigo, this.atendimento, (JFrame)this);
	...
	{
		controlador				= new ControladorAtendimentos();
		List<String> atendimentos	= controlador.getAtendimentos();
		
		DefaultTableModel modelo = (DefaultTableModel) tabelaAtendimentos.getModel();
		
		//Limpa tabela
		while(tabelaAtendimentos.getRowCount() > 0)
			modelo.removeRow(0);
		
		//Insere Novamente
		for(String atendimento : atendimentos)
		{
			modelo.addRow(new String[] {atendimento.toString()});
		}
		controlador = null;
	}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroAtendimentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroAtendimentos().setVisible(true);
            }
        });
    }
	...
	private ControladorAtendimentos		controlador;
