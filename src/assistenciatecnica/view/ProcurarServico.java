 ...
 */
public class ProcurarServico extends javax.swing.JFrame implements KeyListener, ContainerListener
{
    ...
    {//GEN-HEADEREND:event_botaoPesquisarActionPerformed
		...
		this.control	=  new ControladorServico();
		this.servicos	= this.control.buscaServico(this.textoNome.getText());
		
		this.insereDados(this.servicos);
    ...
    {//GEN-HEADEREND:event_botaoSelecionarActionPerformed
		if(tabelaServicos.getSelectedRow() != -1)
		{
			...
			{
				janelaCadastroServicos = (CadastroServicos) janela;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcurarServico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProcurarServico().setVisible(true);
            }
        });
    }
	...
	private ControladorServico	control;
