...
import assistenciatecnica.model.EmailsClientes;
import assistenciatecnica.model.TelefonesClientes;
...
private void textoObsKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoObsKeyTyped
    ...
    {//GEN-HEADEREND:event_botaoSalvarActionPerformed
        if(this.validaCampos())
		{
			...
			if(this.textoCodigo.getText().equals("** NOVO **"))
				...
				this.cliente = control.getClientesByCodigo(Long.parseLong(this.textoCodigo.getText()), this);

			//Definindo os dados
			this.cliente.setNome(this.textoNome.getText());
			if(this.radioPessoaFisica.isSelected())
				this.cliente.setPessoa(true);
			else if(this.radioPessoaJuridica.isSelected())
				this.cliente.setPessoa(false);
			this.cliente.setRg(this.textoRG.getText());
			if(!this.textoCPF.getText().equals(" Â  . Â  . Â  - Â "))
				this.cliente.setCpf(this.textoCPF.getText());
			else
				this.cliente.setCpf(null);
			this.cliente.setNascimento(this.textoNascimento.getCalendar());
			if(this.radioMasculino.isSelected())
				this.cliente.setSexo(true);
			if(this.radioFeminino.isSelected())
				this.cliente.setSexo(false);
			if(!this.textoCNPJ.getText().equals("  .   .   /    -  "))
				this.cliente.setCnpj(this.textoCNPJ.getText());
			else
				this.cliente.setCnpj(null);
			this.cliente.setCpfResponsavel(this.textoCPFResponsavel.getText());
			...
			this.cliente.setEstado(this.comboEstado.getSelectedIndex());
			this.cliente.setCep(this.textoCEP.getText());
			this.cliente.setObservacao(this.textoObs.getText());
			...
			this.cliente.setEmails(emails);
			
			//Atualizando banco
			if(this.textoCodigo.getText().equals("** NOVO **"))
				controlBD.cadastrar(this.cliente, (JFrame)this);
			else
				controlBD.atualizar(this.cliente, (JFrame)this);
    ...
    {//GEN-HEADEREND:event_botaoExcluirActionPerformed
		...
		controlBD.apagar(codigo, this.cliente, (JFrame)this);
