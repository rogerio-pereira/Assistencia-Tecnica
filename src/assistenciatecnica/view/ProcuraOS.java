 ...
 * Data CriaÃ§Ã£o: 24/02/2014
 */
public class ProcuraOS extends javax.swing.JDialog implements KeyListener, ContainerListener{

    /** Creates new form ProcuraEquipamento */
    public ProcuraOS(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
    ...
    private void initComponents()
    {
        ...
        setTitle("Procura Ordem de Serviço");
        setModal(true);
        ...
        botaoLimpar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assistenciatecnica/view/img/edit-delete-2.png"))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(botaoSelecionar, javax.swing.GroupLayout.PREFERRED_SIZE, 122, Short.MAX_VALUE)
        ...
        tabelaOS.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Codigo", "Cliente", "Abertura", "Fechamento", "Finalização"
            }
        )
        {
    ...
    {//GEN-HEADEREND:event_botaoPesquisarActionPerformed
		...
		List<OrdemServico> lista = control.getOrdensServico	(
                                                                this.getCodigo(),
                                                                this.getNome(),
                                                                this.getCpf(),
                                                                this.getCnpj()
    ...
    {//GEN-HEADEREND:event_botaoSelecionarActionPerformed
		if(tabelaOS.getSelectedRow() != -1)
		{
			...
			{
				janelaOrdemDeServico = (OrdemDeServico) this.getParent();
				janelaOrdemDeServico.buscaOS(Long.parseLong(tabelaOS.getValueAt(tabelaOS.getSelectedRow(), 0).toString()));
			}
	...
	private void configuraTabela()
	{
		...
		tabelaOS.getColumnModel().getColumn(0).setCellRenderer(alinhamento);
		...
		tabelaOS.getColumnModel().getColumn(3).setPreferredWidth(95); 
	}
	 ...
	 */
	public void insereDados(List<OrdemServico> lista)
	{
		...
		for(OrdemServico os: lista)
		{
			...
			modelo.addRow(new String[]	{
										...
										sdf.format(os.getAbertura().getTime()),
										fechamento,
										entrega,
									});
		}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcuraOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProcuraOS dialog = new ProcuraOS(new javax.swing.JFrame(), true);
