...
public class ProcuraFornecedores extends javax.swing.JDialog implements KeyListener, ContainerListener{
	...
	if(tabelaClientes.getSelectedRow() != -1)
	{
		...
		else if(janela.getTitle().equals("Cadastro de PeÁas"))
		{
			janelaCadastroPecas = (CadastroPecas) this.getParent();
			if(
				janelaCadastroPecas.adicionaFornecedor(
				...
				JOptionPane.showMessageDialog(janela, "Fornecedor inserido com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("img/accept-grande.png"));
			else
				JOptionPane.showMessageDialog(janela, "Erro ao inserir Fornecedor", "Erro", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("img/error-circle.png"));
		}
	}
